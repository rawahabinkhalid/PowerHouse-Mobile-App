...
const ScopeOfReferralProjectScreen = ({ navigation, route }) => {
  ...
  //   const myArchitects = Architect.map((myValue,myIndex)=>{
  //     return(
  //         <Picker.Item style={{color: '#000', backgroundColor: '#fff'}} label={myValue.ArchitectName} value={myValue.ArchitectName} key={myValue.ArchitectId} />
  //     )
  // })
   ...
   const AddProjectDetail = async() => {
    if( (ProjectLead == '') || (ProjectLead == null) ){
     ...
     if(ProjectDetail.ProjectType.ProjectType == 'Residential'){
      ...
      setLoading(true)
    fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/ReferralResidentialApi.php',{
      method: 'POST',
      headers: {
          "Content-Type": "application/json"
      },
    ...
    .catch((error) => {
      ...
      setLoading(true)
    fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/ReferralCommercialApi.php',{
      method: 'POST',
      headers: {
          "Content-Type": "application/json"
      },
...
export default ScopeOfReferralProjectScreen;