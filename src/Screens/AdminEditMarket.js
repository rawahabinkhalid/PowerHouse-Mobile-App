...
const AdminEditMarketScreen = ({ navigation, route }) => {
   ...
   const findArea = (query) => {
    ...
    return(
      ...
      <View style={{ alignItems: 'center', height: 50, marginTop: 10, marginLeft: 10, marginRight: 10}}>
        ...
        <Text style={{position: 'absolute', backgroundColor: '#fff', marginLeft: 9, color: 'grey', fontSize: 13, bottom: 46}}> Client Type </Text>
        </View>

        <View style={{ marginLeft: 10, marginRight: 10, marginBottom: 3, borderColor: 'grey', borderWidth: 1, marginTop: 5, borderRadius: 5}}>
        <Picker
...
export default AdminEditMarketScreen;