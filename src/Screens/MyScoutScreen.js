...
import { View, Text, TouchableOpacity, Image, ScrollView, BackHandler, Alert, TextInput, FlatList, ActivityIndicator, Modal, LogBox} from 'react-native'
...
const MyScoutScreen = ({ navigation, route }) => {
    ...
    const [AlbumMark, setAlbumMark] = useState([])
     ...
     const GetScoutRes = async() => {
        ...
        try {
            ...
            fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/MyLocationResidentialApi.php',{
          method: 'POST',
          headers: {
    ...
    const GetScoutCom = async() => {
     ...
     try {
         const UserInfo = await AsyncStorage.getItem('UserInfo')
         console.log(UserInfo)
         fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/MyLocationCommercialApi.php',{
       method: 'POST',
       headers: {
           "Content-Type": "application/json"
       },
 ...
 try {
     const UserInfo = await AsyncStorage.getItem('UserInfo')
     console.log(UserInfo)
     fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/MyLocationMarketApi.php',{
   method: 'POST',
   headers: {
       "Content-Type": "application/json"
   },
      ...
      return(
        <View style={{height: '100%', width: '100%', backgroundColor: '#ededed'}}>
          ...
          <View style={{ elevation: 10, flexDirection: 'row', height: 60, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'space-between', width: '100%'}}>
            ...
            <View>
            <Text style={{fontFamily: 'Poppins-Bold', color: '#000', fontSize: 20, paddingTop: 7, paddingLeft: 15}}>Scouted History</Text>
            </View>
      ...
      if(Loading == true){
        ...
        <Text style={{position: 'absolute', backgroundColor: '#ededed', marginLeft: 9, color: 'grey', fontSize: 13, bottom: 47}}> Project Type </Text>
            ...
            style={{height: 300, width: 300}}
              source={require('../Images/NoScout.png')}
            />
            </ScrollView>    
