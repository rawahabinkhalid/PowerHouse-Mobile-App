    ...
    if(Loading == true){
        ...
        <View style={{height: '100%', width: '100%', backgroundColor: '#ededed'}}>
          ...
          <View style={{ elevation: 10, flexDirection: 'row', height: 60, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'space-between', width: '100%'}}>
            ...
            <View>
            <Text style={{fontFamily: 'Poppins-Bold', color: '#000', fontSize: 20, paddingTop: 7, paddingLeft: 15}}>Order Reports</Text>
            </View>
        ...
        setSelectedEmployeeName(itemValue)
        }>
        <Picker.Item style={{color: '#000', backgroundColor: '#ededed'}} label="Select Employee Name" value={null} />
        <Picker.Item style={{color: '#000', backgroundColor: '#ededed'}} label="Hamza" value="Hamza" />
        <Picker.Item style={{color: '#000', backgroundColor: '#ededed'}} label="Taha" value="Taha" />
        <Picker.Item style={{color: '#000', backgroundColor: '#ededed'}} label="Rafay" value="Rafay" />
        </Picker>
    ...
    return(
        <View style={{height: '100%', width: '100%', backgroundColor: '#ededed'}}>
          ...
          <View style={{ elevation: 10, flexDirection: 'row', height: 60, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'space-between', width: '100%'}}>
            ...
            <Text style={{color: '#000', fontFamily: 'Karla-Bold', fontSize: 20, right: 20}}>{TotalOrder}</Text>
        </View>
