...
const FetchCompetitor = async() => {
  ...
  const AddMarketDetail = async() => {
    ...
    fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/MaxID_ScoutMarketApi.php',{
      method: 'POST',
      headers: {
          "Content-Type": "application/json"
      },
    ...
    ////////////////////////////////////////////////////////////
    fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/ScoutMarketApi.php',{
      method: 'POST',
      headers: {
          "Content-Type": "application/json"
      },
  ...
  return(
      ...
      <View>
        ...
        <View>
        <TextInput
        style={{backgroundColor: '#fff', marginLeft: 10, marginRight: 10, marginTop: 5}}
        keyboardType="visible-password"
        theme={{colors: {primary: '#f8ae4e', placeholder: 'grey', text: '#000'}}}
        selectionColor="#000"
        mode= "outlined"
