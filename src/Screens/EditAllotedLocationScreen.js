...
const EditAllotedLocationScreen = ({ navigation, route }) => {
    ...
    useEffect(() => {
      if(ProjectData.Screen == 'Recurring'){
        ...
        EditImages()
        FetchCity()
        FetchbuildingType(ProjectData.EditData.ScoutType)
        getArchitects()
        getBuilders()
        getContractors()
        getInteriorDesigner()
        ...
        setProjectType(ProjectData.EditData.ScoutType)
        ...
        setEarchitectPhoneNumber(ProjectData.EditData.ArchitectPhoneNo)
        setEBuilder(ProjectData.EditData.Builder)
        setEContractor(ProjectData.EditData.CivilContractor)
        ...
        const getBuilders = async() => {
          ...
          const UpdateProject = async() =>{
            setaLoading(true)
              ...
              {
                fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/UpdateAllotedResidentialApi.php',{
                  method: 'POST',
                  headers: {
                      "Content-Type": "application/json"
                  },
                ...
                fetch('https://mobileapp.powerhouse.com.pk/AdminPortal/Api/UpdateAllotedCommercialApi.php',{
                  method: 'POST',
                  headers: {
                      "Content-Type": "application/json"
                  },
...
export default EditAllotedLocationScreen;