...
const ThankYouUpdateScreen = ({ navigation }) => {
    ...
    return(
        ...
        <Text style={{color: '#000', paddingLeft: 30, fontFamily: 'Karla-Regular', fontSize: 20}}>updated</Text>
        </View>
...
export default ThankYouUpdateScreen;