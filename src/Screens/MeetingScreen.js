        ...
        <View style={{height: '100%', width: '100%', backgroundColor: '#fff'}}>
          ...
          <View style={{backgroundColor: '#fff', height: 60, width: '100%', elevation: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
            ...
            <FontAwesome name={"angle-left"} size={35} color={'#000'} />
              ...
              <Text style={{ fontFamily: 'Poppins-Bold', fontSize: 20, color: '#000', paddingTop: 5, paddingLeft: 20}}>Alloted Locations</Text>
        ...
        showsVerticalScrollIndicator= {false}
            ...
            return(
                ...
                <View style={{flexDirection: 'row', marginLeft: 5}}>
                    ...
                    style={{marginLeft: 10, alignSelf: 'center', width: '90%'}}>
                    { (item.OwnerName == null) ?
