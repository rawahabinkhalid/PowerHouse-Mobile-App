...
const MeetingCatalogue = ({ navigation }) => {
    ...
    useEffect(() => {
     ...
     return(
         <View style={{height: '100%', width: '100%', backgroundColor:'#fff'}}>
            ...
            <View>
            <Text style={{fontFamily: 'Poppins-Bold', color: '#000', fontSize: 20, paddingTop: 7, paddingLeft: 15}}>CATALOGS</Text>
            </View>
      ...
      <View style={{marginTop: 20, flexDirection: 'row',width: '60%' ,justifyContent: 'space-between'}}>
          ...
          <TouchableOpacity
          onPress={()=>navigation.navigate("MEETINGPHCATALOGUE",{
...
export default MeetingCatalogue;;