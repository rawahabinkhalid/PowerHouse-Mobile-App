    ...
    return(
        <View style={{height: '100%', width: '100%', backgroundColor: '#fff'}}>
           ...
           <View style={{ elevation: 10, flexDirection: 'row', height: 60, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'space-between'}}>
            <TouchableOpacity
            style={{left: 20}}
            onPress={()=>navigation.navigate("STARTMEETING")}
            >
                <FontAwesome name={"angle-left"} size={35} />
            </TouchableOpacity>
            
            <View>
            <Text style={{fontFamily: 'Poppins-Bold', color: '#000', fontSize: 20, paddingTop: 7, paddingLeft: 15}}>ADD DETAILS</Text>
            </View>
        ...
        >
            ...
            <TouchableOpacity
            style={{backgroundColor: '#fff', height: 40, width: '10%', alignItems: 'center', justifyContent: 'center', borderRadius: 5, borderColor: '#f8ae4e', borderWidth: 2}}
            onPress={()=>{{
                if(Quantity >= 1){
        ...
        <Text style={{fontFamily: 'Poppins-Bold', color: '#000', fontSize: 20,}}>ORDER DETAIL</Text>
        </View>
